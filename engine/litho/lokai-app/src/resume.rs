...
use lokai_inference::{Message, ToolCall};
...
pub fn rehydrate_messages(
    rows: &[lokai_memory::StoredMessageRow],
    total_eligible: u32,
) -> Vec<Message> {
...
fn row_to_message(r: &lokai_memory::StoredMessageRow) -> Message {
...
mod tests {
    use super::*;
    use lokai_memory::StoredMessageRow;
