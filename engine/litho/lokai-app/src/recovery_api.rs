...
use lokai_domain::{RunId, RunState};
...
mod tests {
    ...
    use lokai_domain::{CancelRun, RunCommand};
    use std::sync::Arc;
    ...
    async fn interrupted_run_is_quarantined_and_explicit_abandonment_is_durable() {
        ...
        assert!(app
            ...
            .handle(RunCommand::CancelRun(CancelRun {
                envelope: lokai_run::command_envelope("unreviewed", None, "test"),
                run_id: id.clone(),
            }))
            .await
            .is_err());
    ...
    async fn storage_failure_still_blocks_new_runs_and_abandonment() {
        ...
        assert!(supervisor
            .handle(RunCommand::CancelRun(CancelRun {
                envelope: lokai_run::command_envelope("abandon", Some(1), "test"),
