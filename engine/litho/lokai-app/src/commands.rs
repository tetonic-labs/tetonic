use lokai_domain::{AgentIdentity, AgentJobSpec};
...
pub struct InitializeBootstrapPayload {
    pub workspace_root: String,
    pub policy: std::sync::Arc<lokai_policy::PolicyEngine>,
    pub runtime: std::sync::Arc<lokai_runtime::EngineRuntime>,
    pub inference_defaults: lokai_capacity::InferenceDefaults,
}
...
pub struct StartSessionResultPayload {
    ...
    pub orchestration_mode: lokai_orchestrator::OrchestrationMode,
    pub critic_enabled: bool,
    pub llm_router: bool,
    /// Hydrated conversation for resume; empty for fresh sessions.
    pub messages: Vec<lokai_inference::Message>,
}
...
pub use lokai_run::{StartIdentityJobCommand, StartIdentityJobResult};

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CompleteTurnCommand {
    pub session_id: String,
    pub attempt_id: lokai_domain::AttemptId,
    pub workspace_root: String,
    pub canceled: bool,
    pub error: Option<String>,
}
...
pub struct RegisterApprovalCommand {
    ...
    #[serde(default)]
    pub missing_controls: Vec<lokai_core::ConfinementWarning>,
    #[serde(default)]
...
pub struct BeginOptimizeResultPayload {
    pub job_id: String,
    pub depth: lokai_capacity::OptimizeDepth,
    pub auto_apply: bool,
}
...
pub struct CapacityStatusCommand {
    pub client: std::sync::Arc<dyn lokai_capacity::InferenceClient>,
    pub node_id: String,
...
pub struct CapacityStatusResultPayload {
    pub status: lokai_capacity::CapacityStatus,
}
...
pub struct CapacityDoctorResultPayload {
    pub status: lokai_capacity::CapacityStatus,
    pub diagnosis: lokai_capacity::CapacityDiagnosis,
}
