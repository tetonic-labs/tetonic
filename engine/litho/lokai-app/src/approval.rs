...
use lokai_core::{ApprovalRequest, ConfinementWarning};
...
pub fn attach_shell_confinement(req: &mut ApprovalRequest, workspace: &Path) {
    ...
    let preview = lokai_sandbox::preview_confinement(ProcessClass::ModelRequestedShell, workspace);
...
mod tests {
    use super::*;
    use lokai_core::ApprovalRequest;
