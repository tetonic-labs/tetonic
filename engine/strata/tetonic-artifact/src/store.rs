...
impl LocalArtifactStore {
    ...
    ) -> Result<tetonic_domain::artifact::ArtifactProvenanceBundle, ArtifactError> {
    ...
    pub async fn persist_quarantined_remote(
        ...
        meta.origin = tetonic_domain::ArtifactOrigin::Remote;
...
impl ArtifactStore for LocalArtifactStore {
    ...
    async fn mark_accepted(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            ) && matches!(meta.origin, tetonic_domain::ArtifactOrigin::Local)
            {
