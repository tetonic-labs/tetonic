...
use tetonic_domain::artifact::{ArtifactError, ArtifactMetadata, VerificationState};
use tetonic_domain::result_integrity::ArtifactOrigin;
...
mod tests {
    use super::*;
    use chrono::Utc;
    use tetonic_domain::artifact::{ArtifactKind, ArtifactState, RetentionPolicy};
    ...
    fn test_metadata() -> ArtifactMetadata {
        ArtifactMetadata {
            ...
            storage_location: tetonic_domain::artifact::ArtifactLocation::Remote(
                "http://test".into(),
            ),
