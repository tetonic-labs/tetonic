    ...
    fn upgrade_from_v28_preserves_identity_and_creates_backup() {
        ...
        let path = dir.path().join("upgrade.db");
        {
            ...
            store
                .conn
                .execute_batch(
                    "DROP TABLE control_admin_events; DROP TABLE control_credential_events; DROP TABLE control_credentials; DROP TABLE team_members; DROP TABLE organization_members; DROP TABLE control_principals;
