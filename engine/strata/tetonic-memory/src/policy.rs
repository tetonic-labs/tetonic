...
fn canonical_data_class(class: &str) -> Result<String> {
    tetonic_policy::normalize_data_class_name(class)
...
impl Store {
    ...
    pub fn get_project_placement_policy(&self) -> Result<tetonic_domain::ProjectPlacementPolicy> {
        ...
        Ok(tetonic_domain::ProjectPlacementPolicy {
    ...
    pub fn set_project_placement_policy(
        &self,
        policy: &tetonic_domain::ProjectPlacementPolicy,
    ) -> Result<()> {
        self.set_policy_setting(
...
mod tests {
    ...
    fn project_placement_policy_roundtrip() {
        let store = Store::open(":memory:").unwrap();
        let policy = tetonic_domain::ProjectPlacementPolicy {
