...
pub struct ContextCompiler {
    ...
    revoked_sessions: Mutex<Option<HashSet<lokai_domain::SessionId>>>,
}
...
impl ContextCompiler {
    ...
    pub async fn expand_pack(
        &self,
        request: &lokai_domain::ContextExpansionRequest,
    ...
    async fn expand_within_limits(
            ...
            "file" => {
                ...
                if content.is_empty() {
                    ...
                    vec![ContextEvidence {
                        ...
                        relevance_score: 0.9,
                        ranking_reasons: vec![],
                        data_class: lokai_domain::classify::DataClass::RepositorySource,
                        text: content,
                    }]
                }
            }
        ...
        for mut ev in filtered {
            ...
            use sha2::{Digest, Sha256};
            ev.content_digest = lokai_domain::workspace::ContentDigest(format!(
                "{:x}",
...
impl lokai_domain::ContextCompiler for ContextCompiler {
    ...
    async fn compile(
        &self,
        req: lokai_domain::ContextCompileRequest,
        ...
        Ok(lokai_domain::CompiledContext {
            run_id: pack.run_id,
            ...
            evidence: pack
                .evidence
                .into_iter()
                .map(|ev| lokai_domain::CompiledEvidence {
    ...
    async fn expand(
        &self,
        request: &lokai_domain::ContextExpansionRequest,
    ) -> Result<Vec<lokai_domain::CompiledEvidence>, String> {
