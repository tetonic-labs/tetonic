...
use tetonic_fabric_protocol::{CancellationRequest, WorkerCapabilityAdvertisement};
...
pub trait FabricNodeProvider: InferenceProvider + Send + Sync {
    ...
    fn worker_trust(&self) -> tetonic_domain::WorkerTrust {
        tetonic_domain::WorkerTrust::OwnerControlledEstate
    }

    /// Apply a coordinator trust change immediately (M5-3).
    fn set_worker_trust(&self, _trust: tetonic_domain::WorkerTrust) {}
