...
struct JobRecord {
    ...
    dispatched_class: Option<tetonic_domain::DataClass>,
    project_policy: Option<tetonic_domain::ProjectPlacementPolicy>,
    #[allow(dead_code)]
    created_ms: u64,
}
...
impl ActiveJobRegistry {
    ...
    pub fn mark_dispatched(
        ...
        project_policy: tetonic_domain::ProjectPlacementPolicy,
    ...
    pub fn dispatched_for_worker(
        ...
        tetonic_domain::ProjectPlacementPolicy,
    )> {
        self.state
            .lock()
            .unwrap()
...
mod tests {
    ...
    fn records_dispatched_inputs_for_post_dispatch_trust_audit() {
        ...
        reg.mark_dispatched(
            ...
            &attempt,
            "worker_a",
            tetonic_domain::DataClass::SensitiveSource,
            tetonic_domain::ProjectPlacementPolicy::default(),
        )
        .unwrap();
        let records = reg.dispatched_for_worker("worker_a");
        assert_eq!(records.len(), 1);
        assert_eq!(records[0].0, "job_a");
        assert_eq!(records[0].2, tetonic_domain::DataClass::SensitiveSource);
    }
