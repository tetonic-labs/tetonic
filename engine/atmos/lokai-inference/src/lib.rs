...
//! Production HTTP goes through [`lokai_egress::EgressGuard`]: local/fabric
...
use chrono::Utc;
use lokai_egress::{EgressError, EgressGuard};
...
pub struct FabricCallMeta {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub payload_classification: Option<lokai_domain::ClassificationSummary>,
    ...
    pub input_artifacts: Vec<lokai_domain::ArtifactRef>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub workspace_version: Option<lokai_domain::WorkspaceVersion>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub required_capabilities: Vec<String>,
    #[serde(default)]
    pub trace_context: lokai_domain::TraceContext,
...
impl OllamaProvider {
    ...
    pub async fn model_inventory_capabilities(
        &self,
        resident: &[String],
    ) -> Vec<lokai_fabric_protocol::ModelCapability> {
        use lokai_fabric_protocol::{ModelCapability, ModelLoadState};
...
impl InferenceProvider for OllamaProvider {
    ...
    async fn chat(
        ...
        use lokai_telemetry::{PerfStage, StageTimer};
