...
pub fn placement_request_from_chat(
    ...
    PlacementRequest {
        ...
        verification_policy: req
            ...
            .map(|p| lokai_domain::VerificationPolicyReference {
                policy_id: p.clone(),
            })
            .or_else(|| {
                project_policy.required_verification.as_ref().map(|p| {
                    lokai_domain::VerificationPolicyReference {
                        policy_id: p.clone(),
                    }
                })
            }),
...
pub fn placement_request_from_job(
    ...
    PlacementRequest {
        ...
        input_artifacts: job
            .input_artifacts
            .iter()
            .map(|artifact| lokai_domain::ArtifactRef {
        ...
        trace_context: lokai_domain::TraceContext {
...
mod tests {
    use chrono::Duration;
    use lokai_domain::ids::{AttemptId, JobId, LeaseId, RunId, TaskId, WorkerId};
    ...
    use super::*;
    use lokai_fabric_protocol::CapabilityRegistry;
    ...
    fn request(class: DataClass, worker: Option<&str>, epoch: u64) -> PlacementRequest {
        PlacementRequest {
            ...
            task_id: None,
            attempt_id: None,
            job_kind: lokai_domain::PlacementJobKind::Infer,
            data_class: class,
    ...
    fn required_sandbox_blocks_when_not_enforced() {
        use lokai_domain::placement::SandboxRequirements;
        ...
        let req = PlacementRequest {
            ...
            task_id: None,
            attempt_id: None,
            job_kind: lokai_domain::PlacementJobKind::Compute,
    ...
    fn typed_job(kind: JobKind, class: DataClass) -> JobEnvelope {
        JobEnvelope {
            ...
            workspace_version: None,
            input_artifacts: vec![lokai_fabric_protocol::ArtifactReference {
