...
fn sample_job(input_digest: &str) -> JobEnvelope {
    JobEnvelope {
        ...
        output_limits: lokai_fabric_protocol::OutputLimits {
            max_bytes: 1_000_000,
            max_artifacts: 8,
            max_artifact_size: 500_000,
        },
        verification_policy: Default::default(),
        payload: lokai_fabric_protocol::VersionedJobPayload::V1Infer(serde_json::json!({})),
    }
}
...
fn job_artifact_references_require_digest_binding() {
    ...
    job.input_artifacts = vec![lokai_fabric_protocol::ArtifactReference {
...
fn result_envelope_roundtrip() {
    ...
    use lokai_domain::ids::{KeyId, ResultId};
    use rand::rngs::OsRng;
