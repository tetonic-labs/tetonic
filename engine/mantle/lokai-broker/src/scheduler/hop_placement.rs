...
use chrono::Utc;
use lokai_domain::{PlacementReason, ProjectPlacementPolicy, TrustPlacementDecision, WorkerTrust};
use lokai_fabric_protocol::{CapabilityRegistry, ModelSelection};
use lokai_inference::{evaluate_placement, placement_request_from_chat, ChatRequest};
...
mod tests {
    ...
    use lokai_fabric_protocol::{CapabilityRegistry, JobKind, WorkerCapabilities};
