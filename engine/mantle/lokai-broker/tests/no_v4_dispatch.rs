...
use lokai_broker::*;
use lokai_domain::ids::{ActionId, AgentId, AttemptId, RunId, SessionId, TaskId, WorkerId};
    ...
    AuthorizedProcessRequest {
        ...
        authorized_action: AuthorizedAction {
            capability: IssuedCapability {
                capability_id: lokai_domain::CapabilityId::new("cap_nov4"),
...
fn named_worker_embed_refused_when_ads_are_infer_only() {
    ...
    match lokai_broker::dispatch::revalidate_before_dispatch(&req, Some(&caps), now) {
