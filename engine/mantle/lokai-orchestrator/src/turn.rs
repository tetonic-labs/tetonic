...
use lokai_core::{Agent, Conversation, SpawnHook, SpawnRequest, Step};
use lokai_domain::{AgentInvocation, AttemptId, CandidateOutcome};
...
pub struct AgentBuildRequest {
    ...
    pub inherited_workspace_version: Option<lokai_domain::WorkspaceVersion>,
}
    ...
    E: RootExecute,
{
    ...
    if spawn_ok {
        ...
        lokai_tools::ToolOutcome::fail(message, "other")
    }
}
