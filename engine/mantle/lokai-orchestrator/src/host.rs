...
use lokai_domain::{CodeIndexOpen, DataClass, DisclosureTier, LspSessionOpen};
use lokai_policy::{
...
impl SessionHost {
    ...
    pub fn on_session_start(
        ...
        store: Option<&lokai_memory::Store>,
    ...
    pub fn on_turn_end(
        &self,
        _session_id: &str,
        _store: Option<&lokai_memory::Store>,
    ) -> TurnHooks {
    ...
    pub fn on_session_end(&self, session_id: &str, store: Option<&lokai_memory::Store>) {
        if let Some(s) = store {
