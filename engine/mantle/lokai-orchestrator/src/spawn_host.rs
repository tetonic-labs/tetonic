...
use lokai_core::{Conversation, SpawnHook, SpawnRequest, Step};
...
type AgentBuildFn = dyn FnMut(AgentBuildRequest, &str) -> Result<(lokai_core::Agent, AgentInvocation), String>
    + Send;
