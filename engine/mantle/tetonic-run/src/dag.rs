...
use tetonic_domain::{DependencyPolicy, RunSnapshot, TaskDependency, TaskId, TaskState};
...
mod tests {
    use super::*;
    use tetonic_domain::{RunId, SessionId, TaskInputBinding, TaskRecord};
    ...
    fn recompute_demotes_ready_when_dependency_added() {
        ...
        snap.state = tetonic_domain::RunState::Active;
        snap.sequence = 1;
        snap.tasks.insert(
            dep.clone(),
            TaskRecord {
