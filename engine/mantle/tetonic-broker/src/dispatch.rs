...
use tetonic_domain::TrustPlacementDecision;
use tetonic_fabric_protocol::{CapabilityRegistry, JobKind, WorkerSchedulingState};
use tetonic_inference::LOCAL_NODE_ID;
...
mod tests {
    ...
    use tetonic_fabric_protocol::{JobKind, WorkerCapabilities};
