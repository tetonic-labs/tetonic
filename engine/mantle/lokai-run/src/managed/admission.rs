...
impl super::service::ManagedRunService {
    ...
    async fn admit_owned(
            ...
            &job.parent_attempt
        {
            ...
            let added = self
                .supervisor
                .handle(RunCommand::AddTask(lokai_domain::AddTask {
        ...
        if was_canceled {
            ...
            self.finalize(FinalizeJob {
                ...
                outcome: lokai_domain::CandidateOutcome::Canceled {
...
impl super::service::ManagedRunService {
    ...
    pub async fn create_run(
        &self,
        session_id: Option<lokai_domain::SessionId>,
        task_id: Option<TaskId>,
        identity: Option<lokai_domain::AgentIdentity>,
        job_spec: Option<lokai_domain::AgentJobSpec>,
