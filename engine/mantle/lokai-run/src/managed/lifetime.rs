use super::contracts::*;
use lokai_domain::{AttemptId, HeartbeatReport, LeaseProof, RecordHeartbeat, RunCommand};
...
pub struct ActiveAttempt {
    pub work_scope: lokai_domain::work_scope::WorkScope,
    pub binding: ManagedBinding,
    pub identity: lokai_domain::AgentIdentity,
...
impl super::service::ManagedRunService {
    pub fn active_bindings(&self, run: &lokai_domain::RunId) -> Vec<ManagedBinding> {
        self.active
            .lock_recover()
            .values()
