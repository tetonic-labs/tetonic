...
use tetonic_memory::{WorkerStore, WorkerStoreError};
...
pub fn node_capacity_from_wire(wire: &WorkerCapacityWire) -> tetonic_inference::NodeCapacityHealth {
    tetonic_inference::NodeCapacityHealth {
