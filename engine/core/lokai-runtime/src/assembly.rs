...
use lokai_domain::ContextCompiler;
...
pub struct AgentAssemblyParts {
    ...
    pub process_broker: Option<Arc<dyn lokai_domain::sinks::ProcessBroker>>,
...
impl EngineRuntime {
    pub fn new(
        policy: Arc<PolicyEngine>,
        _approval_hook: Option<lokai_core::ApprovalHook>,
        artifact_store: Arc<dyn lokai_domain::artifact::ArtifactStore>,
    ) -> Self {
    ...
    pub fn artifact_store(&self) -> &Arc<dyn lokai_domain::artifact::ArtifactStore> {
        &self.artifact_store
    }
