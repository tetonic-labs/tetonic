...
fn test_capability_hooks() -> (
    tetonic_core::PostEditSnapshot,
    tetonic_core::ResolveUnderRoot,
...
fn sample_parts(
    audit: Box<dyn tetonic_core::AuditSink>,
...
fn production_assembly_attaches_supplied_context_compiler() {
    ...
    impl tetonic_domain::ContextCompiler for MockCompiler {
        async fn compile(
            &self,
            _req: tetonic_domain::ContextCompileRequest,
