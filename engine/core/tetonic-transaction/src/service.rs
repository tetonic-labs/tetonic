...
pub struct WorkspaceTransaction {
    ...
    read_snapshot: std::collections::BTreeMap<WorkspacePath, tetonic_domain::ContentDigest>,
...
impl WorkspaceTransactionService {
    ...
    pub fn commit_active_if_any(
        ...
        let result = {
            let _txn_stage = tetonic_telemetry::enter_stage_child("txn_commit");
        ...
        match apply_journal(&self.root, &mut journal, &self.lokai_dir) {
            Ok(()) => {
                ...
                let artifact = TransactionArtifact {
                    ...
                    patch_artifact_id: tetonic_domain::ids::ArtifactId::new(format!(
                        "patch-{}",
                    ...
                    verification_artifact_id: self.verification.as_ref().map(|v| {
                        tetonic_domain::ids::ArtifactId::new(format!(
                            "verify-{}",
                            v.output_digest.0
                        ))
                    }),
